...
export class News extends Component {
    ...
    async componentDidMount() {
        let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=049e0196f4584429ae9a41b7da6574d5&page=1&pagesize=${this.props.pagesize}`
    ...
    handleprev = async () => {
        let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=049e0196f4584429ae9a41b7da6574d5&page=${this.state.page - 1}&pagesize=${this.props.pagesize}`
